...
const AddProducts = () => {
    ...
    useEffect(() => {
        let resdata = async () => {
            let res = await axios.get(URL+'/userAdmin/getallcategory')
    ...
    const handleSubmit = async (e) => {
        ...
        if(file){
            ...
            try {
                let res = await axios.post(URL+"/admin/adminImageUpload", data)
                console.log(res);
            } catch (error) {
                console.log(error);
            }
        ...
        try {
            let res = await axios.post(URL+'/userAdmin/createProducts', prod)
            if(res){
